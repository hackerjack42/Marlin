...
#define STRING_CONFIG_H_AUTHOR "(Jack Hain, BTT002, Stock Frame, Bondtech BMG)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MK3S BTT002"
...
#define Z_PROBE_SPEED_FAST ((40*60) * 4)
